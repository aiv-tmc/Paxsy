...
static void init_type_cache(void) {
    ...
    type_Int32 = type_basic(TYPE_BASIC_INT32);
    type_Bool = type_basic(TYPE_BASIC_BOOL);
    type_Void = type_basic(TYPE_BASIC_VOID);
    type_Auto = type_basic(TYPE_BASIC_AUTO);
