...
static int start_function_declared = 0;
...
static Type *parse_type_spec(void) {
    ...
    if (type->size == 0) {
        if (strcmp(type->name, "int") == 0) type->size = 32;
        else if (strcmp(type->name, "real") == 0) type->size = 64;
        else if (strcmp(type->name, "char") == 0) type->size = 8;
    }
...
static ASTNode *parse_syscall(void) {
    ...
    // Check for valid syscall numbers (0x60, 0x1, 0x2)
    Token *num_token = current_token();
    char *syscall_num = strdup(num_token->value);
    if (strcmp(syscall_num, "0x0") != 0     &&
        strcmp(syscall_num, "0x1") != 0     &&
        strcmp(syscall_num, "0x2") != 0     &&
        strcmp(syscall_num, "0x3") != 0     &&
        strcmp(syscall_num, "0x4") != 0     &&
        strcmp(syscall_num, "0x5") != 0     &&
        strcmp(syscall_num, "0x6") != 0     &&
        strcmp(syscall_num, "0x7") != 0     &&
        strcmp(syscall_num, "0x8") != 0     &&
        strcmp(syscall_num, "0x9") != 0     &&
        strcmp(syscall_num, "0xA") != 0     &&
        strcmp(syscall_num, "0xB") != 0     &&
        strcmp(syscall_num, "0xC") != 0     &&
        strcmp(syscall_num, "0xD") != 0     &&
        strcmp(syscall_num, "0xE") != 0     &&
        strcmp(syscall_num, "0xF") != 0     &&
        strcmp(syscall_num, "0x10") != 0    &&
        strcmp(syscall_num, "0x11") != 0    &&
        strcmp(syscall_num, "0x12") != 0    &&
        strcmp(syscall_num, "0x13") != 0    &&
        strcmp(syscall_num, "0x14") != 0    &&
        strcmp(syscall_num, "0x15") != 0    &&
        strcmp(syscall_num, "0x16") != 0    &&
        strcmp(syscall_num, "0x17") != 0    &&
        strcmp(syscall_num, "0x18") != 0    &&
        strcmp(syscall_num, "0x19") != 0    &&
        strcmp(syscall_num, "0x1A") != 0    &&
        strcmp(syscall_num, "0x1B") != 0    &&
        strcmp(syscall_num, "0x1C") != 0    &&
        strcmp(syscall_num, "0x1D") != 0    &&
        strcmp(syscall_num, "0x1E") != 0    &&
        strcmp(syscall_num, "0x1F") != 0    &&
        strcmp(syscall_num, "0x20") != 0    &&
        strcmp(syscall_num, "0x21") != 0    &&
        strcmp(syscall_num, "0x22") != 0    &&
        strcmp(syscall_num, "0x23") != 0    &&
        strcmp(syscall_num, "0x24") != 0    &&
        strcmp(syscall_num, "0x25") != 0    &&
        strcmp(syscall_num, "0x26") != 0    &&
        strcmp(syscall_num, "0x27") != 0    &&
        strcmp(syscall_num, "0x28") != 0    &&
        strcmp(syscall_num, "0x29") != 0    &&
        strcmp(syscall_num, "0x2A") != 0    &&
        strcmp(syscall_num, "0x2B") != 0    &&
        strcmp(syscall_num, "0x2C") != 0    &&
        strcmp(syscall_num, "0x2D") != 0    &&
        strcmp(syscall_num, "0x2E") != 0    &&
        strcmp(syscall_num, "0x2F") != 0    &&
        strcmp(syscall_num, "0x30") != 0    &&
        strcmp(syscall_num, "0x31") != 0    &&
        strcmp(syscall_num, "0x32") != 0    &&
        strcmp(syscall_num, "0x33") != 0    &&
        strcmp(syscall_num, "0x34") != 0    &&
        strcmp(syscall_num, "0x35") != 0    &&
        strcmp(syscall_num, "0x36") != 0    &&
        strcmp(syscall_num, "0x37") != 0    &&
        strcmp(syscall_num, "0x38") != 0    &&
        strcmp(syscall_num, "0x39") != 0    &&
        strcmp(syscall_num, "0x3A") != 0    &&
        strcmp(syscall_num, "0x3B") != 0    &&
        strcmp(syscall_num, "0x3C") != 0    &&
        strcmp(syscall_num, "0x3D") != 0    &&
        strcmp(syscall_num, "0x3E") != 0    &&
        strcmp(syscall_num, "0x3F") != 0    &&
        strcmp(syscall_num, "0x40") != 0    &&
        strcmp(syscall_num, "0x41") != 0    &&
        strcmp(syscall_num, "0x42") != 0    &&
        strcmp(syscall_num, "0x43") != 0    &&
        strcmp(syscall_num, "0x44") != 0    &&
        strcmp(syscall_num, "0x45") != 0    &&
        strcmp(syscall_num, "0x46") != 0    &&
        strcmp(syscall_num, "0x47") != 0    &&
        strcmp(syscall_num, "0x48") != 0    &&
        strcmp(syscall_num, "0x49") != 0    &&
        strcmp(syscall_num, "0x4A") != 0    &&
        strcmp(syscall_num, "0x4B") != 0    &&
        strcmp(syscall_num, "0x4C") != 0    &&
        strcmp(syscall_num, "0x4D") != 0    &&
        strcmp(syscall_num, "0x4E") != 0    &&
        strcmp(syscall_num, "0x4F") != 0    &&
        strcmp(syscall_num, "0x50") != 0    &&
        strcmp(syscall_num, "0x51") != 0    &&
        strcmp(syscall_num, "0x52") != 0    &&
        strcmp(syscall_num, "0x53") != 0    &&
        strcmp(syscall_num, "0x54") != 0    &&
        strcmp(syscall_num, "0x55") != 0    &&
        strcmp(syscall_num, "0x56") != 0    &&
        strcmp(syscall_num, "0x57") != 0    &&
        strcmp(syscall_num, "0x58") != 0    &&
        strcmp(syscall_num, "0x59") != 0    &&
        strcmp(syscall_num, "0x5A") != 0    &&
        strcmp(syscall_num, "0x5B") != 0    &&
        strcmp(syscall_num, "0x5C") != 0    &&
        strcmp(syscall_num, "0x5D") != 0    &&
        strcmp(syscall_num, "0x5E") != 0    &&
        strcmp(syscall_num, "0x5F") != 0    &&
        strcmp(syscall_num, "0x60") != 0    &&

        strcmp(syscall_num, "0x1B4") != 0   &&
        strcmp(syscall_num, "0x1B5") != 0   &&
        strcmp(syscall_num, "0x1B6") != 0   &&
        strcmp(syscall_num, "0x1B7") != 0   &&
        strcmp(syscall_num, "0x1B8") != 0   &&
        strcmp(syscall_num, "0x1B9") != 0   &&
        strcmp(syscall_num, "0x1BA") != 0   &&
        strcmp(syscall_num, "0x1BB") != 0   &&
        strcmp(syscall_num, "0x1BC") != 0   &&
        strcmp(syscall_num, "0x1BD") != 0   &&
        strcmp(syscall_num, "0x1BE") != 0   &&
        strcmp(syscall_num, "0x1BF") != 0   &&
        strcmp(syscall_num, "0x1C0") != 0   &&
        strcmp(syscall_num, "0x1C1") != 0   &&
        strcmp(syscall_num, "0x1C2") != 0   &&
        strcmp(syscall_num, "0x1C3") != 0) {
...
static ASTNode *parse_function(void) {
    ...
    if (is_start) {
        if (start_function_declared) error("Only one start function allowed");
        start_function_declared = 1;
        ASTNode *node = create_ast_node(AST_STARTFUNC, 0, func_name, args, body, NULL);
...
// Parse variable declaration with type checking
static ASTNode *parse_variable_decl(void) {
    ...
    for (int i = 0; i < symbol_count; i++) {
        if (strcmp(symbol_table[i], var_name) == 0) {
            free(var_name);
    ...
    if (symbol_count >= symbol_capacity) {
        ...
        if (!symbol_table) error("Memory allocation failed");
    }
    symbol_table[symbol_count++] = var_name;
    ...
    if (TRY_CONSUME(TOKEN_EQUAL)) {
        ...
        if (init) {
            // Check if initializer is a literal
            if (init->type == AST_LITERAL) {
                // Compare literal type with variable type
                if (strcmp(var_type->name, "int") == 0 && init->op_type != TOKEN_NUMBER) {
                    error("Type mismatch: cannot assign non-integer to int variable");
                }
                else if (strcmp(var_type->name, "real") == 0 && init->op_type != TOKEN_NUMBER) {
                    error("Type mismatch: cannot assign non-real to real variable");
                }
                else if (strcmp(var_type->name, "char") == 0 && init->op_type != TOKEN_CHAR) {
                    error("Type mismatch: cannot assign non-char to char variable");
                }
                
                // Check base for integer literals
                if (strcmp(var_type->name, "int") == 0 && var_type->base != 0 && init->op_type == TOKEN_NUMBER) {
                    char *literal_str = init->value;
                    if (var_type->base == 2) {
                        if (strncmp(literal_str, "0b", 2) != 0) {
                            error("Literal must be binary (0b...) for base 2");
                        }
                    } else if (var_type->base == 10) {
                        if (strncmp(literal_str, "0x", 2) == 0 || strncmp(literal_str, "0b", 2) == 0) {
                            error("Literal must be decimal for base 10");
                        }
                    } else if (var_type->base == 16) {
                        if (strncmp(literal_str, "0x", 2) != 0) {
                            error("Literal must be hex (0x...) for base 16");
                        }
                    }
                }
            }
            // Handle unary minus expressions
                     ...
                     (init->op_type == TOKEN_MINUS || init->op_type == TOKEN_PLUS) &&
                     init->right->type == AST_LITERAL && 
                     init->right->op_type == TOKEN_NUMBER) {
                if (strcmp(var_type->name, "int") == 0 && var_type->base != 0) {
                    char *literal_str = init->right->value;
                    if (var_type->base == 2) {
                        if (strncmp(literal_str, "0b", 2) != 0) {
                            error("Literal must be binary (0b...) for base 2");
                        }
                    } else if (var_type->base == 4) {
                        if (strncmp(literal_str, "0q", 2) == 0) {
                            error("Literal must be Quat (0q...) for base 4");
                        }
                    } else if (var_type->base == 8) {
                        if (strncmp(literal_str, "0o", 2) == 0) {
                            error("Literal must be Octal (0o...) for base 8");
                        }
                    } else if (var_type->base == 10) {
                        if (strncmp(literal_str, "0b", 2) == 0) {
                            error("Literal must be decimal for base 10");
                    ...
                    } else if (var_type->base == 32) {
                        if (strncmp(literal_str, "0t", 2) == 0) {
                            error("Literal must be Trigesimal (0t...) for base 32");
                        }
                    } else if (var_type->base == 36) {
                        if (strncmp(literal_str, "0s", 2) == 0) {
                            error("Literal must be Sextrig (0s...) for base 36");
                        }
                    }
                }
            }
...
static ASTNode *parse_compile(void) {
    CONSUME(TOKEN_COMPILE);
    CONSUME(TOKEN_LPAREN);
    ASTNode *args = NULL;
    if (!MATCH(TOKEN_RPAREN)) {
        args = parse_expression();
    ...
    return create_ast_node(AST_COMPILE, 0, "compile", args, body, NULL);
}
...
AST *parse(Token *input_tokens, int input_token_count) {
    ...
    if (!start_function_declared && ast->count > 0) {
